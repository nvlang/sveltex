...
module.exports = grammar({
    // SVELTEX FORK: renamed from `markdown` to avoid symbol/name clashes with
    // Zed's built-in markdown grammar (the parser exports
    // `tree_sitter_markdown_sveltex`, and Zed resolves the injected language by
    // this name).
    name: 'markdown_sveltex',
