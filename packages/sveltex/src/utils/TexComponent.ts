...
import type { KeyPath, SveltexCache } from './cache.js';
...
import { log, prettifyError, time, timeSince, timeToString } from './debug.js';
import { insteadGot } from './diagnosers/Diagnoser.js';
