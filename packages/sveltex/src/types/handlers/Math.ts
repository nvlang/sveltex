...
export interface SveltexMathjaxConfig {
    ...
    /**
     * ⚠ **Warning:** You'll have to delete the previous MathJax CSS file
     * generated by SvelTeX if you change this property, otherwise the changes
     * won't take effect.
     *
     ...
     * - [`'bonum'`](https://www.npmjs.com/package/@mathjax/mathjax-bonum-font):
     *   "A version of the Gyre Bonum font".
     * - [`'dejavu'`](https://www.npmjs.com/package/@mathjax/mathjax-dejavu-font):
     *   "A version of the Gyre DejaVu font".
     * - [`'fira'`](https://www.npmjs.com/package/@mathjax/mathjax-fira-font):
     *   "A version of the Fira and Fira-Math fonts".
     * - [`'modern'`](https://www.npmjs.com/package/@mathjax/mathjax-modern-font):
     *   "A version of Latin-Modern".
     * - [`'pagella'`](https://www.npmjs.com/package/@mathjax/mathjax-pagella-font):
     *   "A version of the Gyre Pagella font".
     * - [`'schola'`](https://www.npmjs.com/package/@mathjax/mathjax-schola-font):
     *   "A version of the Gyre Schola font".
     * - [`'stix2'`](https://www.npmjs.com/package/@mathjax/mathjax-stix2-font):
     *   "A version of the STIX2 font".
     * - [`'termes'`](https://www.npmjs.com/package/@mathjax/mathjax-termes-font):
     *   "A version of the Gyre Termes font".
     * - [`'tex'`](https://www.npmjs.com/package/@mathjax/mathjax-tex-font):
