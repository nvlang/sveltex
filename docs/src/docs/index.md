...
-   <PhBooks :size="28" weight="duotone"/>
    ...
    **Extensive documentation:** With these docs and the extensive IntelliSense
    and hints that %LINES_OF_COMMENTS%+ lines of comments provides, you'll find that almost
    every function or type in SvelTeX is documented, be it user-facing or
    internal.

-   <PhFeather :size="28" weight="duotone"/>

    **Small codebase:** At just under %LINES_OF_CODE% lines of code[^1], SvelTeX's
...
-   <PhUmbrellaSimple :size="28" weight="duotone"/>
    ...
    **Robust:** [Fuzzy](https://en.wikipedia.org/wiki/Fuzzing) testing with
    ...
    tests with [Playwright](https://playwright.dev/) (%E2E_SNAPSHOTS%+ snapshots), and
    %UNIT_TESTS%+ unit tests with [Vitest](https://vitest.dev/) provide 100% code
    coverage.
