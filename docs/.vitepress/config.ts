...
// Auto-generated by `docs/scripts/build-api.mjs` (`build:api`, runs via
// predev/prebuild) from `@nvl/sveltex`'s TSDoc. Gitignored, so it is always
// regenerated before this config is loaded.
import apiSidebar from '../src/api/api-sidebar.json';
