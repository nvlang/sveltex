export const wikipediaHtmlExcerpt = `
<a>Jump to content</a>
<div>
    <header>
        <div>
            <nav>
                <div id="vector-main-menu-dropdown">
                    ...
                    <div>
                        <div id="vector-main-menu-unpinned-container">
                            <div id="vector-main-menu">
                                <div
                                        ...
                                        <ul>
                                            ...
                                            <li id="n-randompage">
                                                <a
                                                    ...
                                                    title="Visit a randomly selected article [ctrl-option-x]"
                                                    accesskey="x"
                                                    ><span
                                                        >Random article</span
                                                    ></a
                                        ...
                                        <ul>
                                            ...
                                            <li id="n-recentchanges">
                                                <a
                                                    ...
                                                    title="A list of recent changes to Wikipedia [ctrl-option-r]"
                                                    accesskey="r"
                                                    ><span
                                                        >Recent changes</span
                                                    ></a
