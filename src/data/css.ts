 ...
 * `#`.
 */
const reservedHexColors: ReservedHexColor[] = Object.keys(
    nameOfHexColor,
) as ReservedHexColor[];
 ...
 * `#`.
 */
const namedColors: NamedColor[] = Object.keys(hexOfNamedColor) as NamedColor[];
...
export function isNamedColor(color: string): color is NamedColor {
    return namedColors.includes(color as NamedColor);
}
